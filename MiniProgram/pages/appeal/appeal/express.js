// pages/appeal/appeal/express.js
const app=getApp()
Page({
  ...
  formexpresssubmit: function(param){
    ...
    var expId=param.detail.value.requestID
    var expCom=param.detail.value.requestCompany
    var demand='取件人为: '+username+' 联系方式为: '+phone+' 快递单号为: '+expId+' 快递公司为: '+expCom
    
      if(departure==""||destination==""||price==""||username==""||phone==""||expId==""||expCom==""){
        this.setData({
          flag:false
        })
        wx.showModal({
