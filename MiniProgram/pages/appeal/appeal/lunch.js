...
Page({
  ...
  formlunchsubmit: function(param){
    ...
    var lunchdemand=param.detail.value.requestDemand
    var demand='联系人为: '+username+' 联系方式为: '+phone+' 取餐需求为: '+lunchdemand
    if(departure==""||destination==""||price==""||username==""||phone==""||lunchdemand==""){
      this.setData({
        flag:false
      })
      wx.showModal({
