...
Page({
  ...
  formrunservicesubmit: function(param){
    ...
    var rundemand=param.detail.value.requestDemand
    var demand='联系人为: '+username+' 联系方式为: '+phone+' 跑腿需求为: '+rundemand
    if(departure==""||destination==""||price==""||username==""||phone==""||rundemand==""){
      this.setData({
        flag:false
      })
      wx.showModal({
